SampleApp = (function () {
    ...
    function showParameterError() {
        ...
        statusElement.innerHTML = "Error: Missing required parameters. URL must include 'callback' and 'user_id' parameters.";
        statusElement.style.color = "red";
    }

    // Wait for onload to be complete before attempting to access the Browser SDK.
    window.onload = function () {
        // Get userId and callback URL from URL parameters
        userId = getUrlParameter('user_id');
        callbackUrl = getUrlParameter('callback');
